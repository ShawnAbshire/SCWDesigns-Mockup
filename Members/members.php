                ...
                <div class="main-content">
                    <section class="containment">
                        <div class="page-header">
                            <div class="header">
                                <h1><i class="zmdi zmdi-accounts"></i> Members</h1>
                                <p>Here you are able to manage all your members.  You can deactivate or lock an account, but you can not delete them.</p>
                            </div>

                            <div class="actions">
                                <a href="#!" class="btn btn-floating waves-effect wave-light pink lighten-2 tooltipped" data-position="top" data-tooltip="New User"><i class="zmdi zmdi-plus"></i></a>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="content-table table">
                        <table id="users-list" class="users-list no-labels striped">
                            <thead>
                                <tr class="users-list">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="profile-name"><a href="details.php">Shane Abshire</a></div>
                                        <span class="user-email">abshire.shawn@gmail.com</span>
                                    </td>
                                    <td>Registered_User, Super_User</td>
                                    <td>Saturday, April 16, 2016</td>
                                    <td>23</td>
                                    <td class="right-align">
                                        <button class="btn btn-flat btn-floating"><i class="zmdi zmdi-power"></i></button>
                                        <button class="btn btn-flat btn-floating"><i class="zmdi zmdi-lock"></i></button>
                                        <button class="btn btn-flat btn-floating"><i class="zmdi zmdi-view-subtitles"></i></button>
