...
<html>
	...
	<body>
                ...
                <ul class="menu">
                    ...
                    <li class="selected">
                        ...
                        <ul class="collapse">
                            ...
                            <li><a class="selected" href="sales.php">Sales</a></li>
                    ...
                    <div class="nav-container">
                        <div class="navbar-left">
                            ...
                            <div class="breadcrumb-container">
                                ...
                                <a href="#!" class="breadcrumb">Sales List</a>
                            </div>
                        </div>
                        <ul class="search">
                ...
                <div class="main-content">
                    <section class="containment">
                        <div class="page-header">
                            <div class="header">
                                <h1><i class="zmdi zmdi-tag"></i> Sales</h1>
                                <p>Here you are able to manage all your sales.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="content-table table">
                        <table id="sales-list" class="sales-list no-labels striped">
                            <thead>
                                <tr class="sales-list">
                                    ...
                                    <th>Start Date</th>
                                    <th>End Date</th>
                                    <th class="center-align">Product Count</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="right-align">
                                        ...
                                        <a href="#" class="btn btn-flat btn-floating"><i class="zmdi zmdi-delete"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <script type="text/javascript">
            ...
            // DataTables
            var salesList = $('#sales-list').DataTable({
                "order": [[ 5, "desc" ]],
                "aoColumnDefs": [
