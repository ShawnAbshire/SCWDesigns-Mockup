...
<html>
	<head>
        ...
        <title>SCWDesigns - Reviews</title>
	</head>
	...
	<body>
                ...
                <ul class="menu">
                    ...
                    <li class="selected">
                        ...
                        <ul class="collapse">
                            ...
                            <li><a class="selected" href="reviews.php">Reviews</a></li>
                    ...
                    <div class="nav-container">
                        <div class="navbar-left">
                            ...
                            <div class="breadcrumb-container">
                                ...
                                <a href="#!" class="breadcrumb">Catalog</a>
                                <a href="#!" class="breadcrumb">Product Reviews</a>
                            </div>
                        </div>
                        <ul class="search">
                ...
                <div class="main-content">
                    <section class="containment">
                        <div class="page-header">
                            <div class="header">
                                <h1><i class="zmdi zmdi-comments"></i> Product Reviews</h1>
                                <p>Here you are able to manage all your product reviews.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="content-table table">
                        <table id="reviews-list" class="reviews-list no-labels striped">
                            <thead>
                                <tr class="reviews-list">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-flat btn-floating"><i class="zmdi zmdi-edit"></i></a>
        ...
        <script type="text/javascript">
            ...
            // DataTables
            var reviewsList = $('#reviews-list').DataTable({
                "order": [[ 1, "desc" ]],
                "aoColumnDefs": [
